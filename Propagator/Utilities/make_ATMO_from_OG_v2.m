function [Atmo_amp, Atmo_pha] = make_ATMO_from_OG_v2(IMAGE_INDEXES, WFTIME_STEP, TIME_SPAN,WFsize)

NB_TSPAN = length(IMAGE_INDEXES)/2;
...
for ii = (2+IMAGE_INDEXES(1)):(1+IMAGE_INDEXES(1) + (2*NB_TSPAN))
